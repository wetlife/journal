...
A restaurant is a financial entity that could own the land that produces food and its lineage.
Lineage could be in a item on a menu.
The menu contains the story of each ingredient's lineage.
