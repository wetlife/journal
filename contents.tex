...
\subsection*{ On the Evolutionary Utility of Cancer }
- Chronic trauma is correlated with carcinogenesis#cite.
- Cancerous cells are genetically heterogeneous.#cite
- Humans are modeled as genetically evolving only through sexual reproduction.#cite
- Cancers are observed to undergo somatic evolution by natural selection within an organism.
- Chronic trauma can be a pathological indication of an emerging environ.
- Many known causes of cancer are abruptly emergent environs.
- How many organisms have been exposed to the environmental toxins associated with increased incidences of primarily gonadal cancers?(A review of the role of emerging environmental contaminants in the development of breast cancer in women)
- Several emerging exposures to substances at toxic densities primarily affect the location where sex cells are produced in organisms modeled to genetically evolve through reproduction.
- Sunlight is considered necessary for utilization of the prefactors of bioavailable vitamin D.
- Incidence of melanoma doubles with five sunburns.(#cite Timing of excessive ultraviolet radiation and melanoma: epidemiology does not support the existence of a critical period of high susceptibility to solar ultraviolet radiation-induced melanoma.)
- How many hominids have exposure to cigarette-smoke?
- Many cancers' incidences are correlated with emerging environs:
  - Smokers develop lung-cancers.
  - Those who breath asbestos develop mesothelioma, a telling form of cancer, in the lungs.
  - Those who chew develop oral cancers.
  - Those who get burned by the sun develop skin-cancers.
  - Those who eat toxins develop cancers in the gastrointestinal tract.
  - Those who experience chronic trauma to a location experience local tumorigenesis.
- ...
