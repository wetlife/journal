...
(;) is an emoji I just made up to wink at those forward individuals amongst us and those some would call backwords. Backwords was a phonetically driven mistake and is now a source of smiles.
...
I believe recipes can be short and sweet for all readers.
...
\subsubsection*{a general preparation's explanations}
\begin{enumerate}
...
A forest containing a trombe-wall is more than one instant's gift.
...
\subsection*{ I plan to meditate my mind to a practiced focus of the kind people call in the zone. }
...
\subsection*{ Let us discuss our way to peace. }
...
Has anyone at NREL investigated sorting, processing, and reclaiming materials and fuels from landfills with robots?
...
\section*{ 2019.08.28at21.50.39 }
\subsection*{ Harvesting thermal energy. }
Heat engines harvest mechanical energy from differences in thermal energy with an efficiency \(\eta\) that is bounded above by the complement of the ratio of the thermal energy of the hot reservoir to the thermal energy of the cold reservoir:

\begin{equation}
	\eta_{\textrm{Carnot}} = 1 - \frac{\textrm{T}_\textrm{C}}{\textrm{T}_\textrm{H}} = \frac{T_C}{T_H}
\end{equation}

where \(\eta_{\textrm{th}}\) is the thermal efficiency defined by

\begin{\label{eqn:carnot-efficiency}equation}
	\eta_{\textrm{th}} = \frac{\textrm{W}_\textrm{out}}{\textrm{Q}_\textrm{in}} = \frac{\textrm{Q}_\textrm{in} - \textrm{Q}_\textrm{out}}{\textrm{Q}_\textrm{in}} = 1 - \frac{\textrm{Q}_\textrm{out}}{\textrm{Q}_\textrm{in}}.
\end{equation}

Dimensional considerations yield an interesting point: we use thermal terms to define the supremum of the energy which may be produced.
We have shown in \ref{eqn:carnot-efficiency} thermal terms form a theoretical set of bases by which maximal energy output 

\section*{ 2019.11.04at20.19.01 }
\subsection*{ I love that I can go play my guitar tighter as in tighter to my body for a more dynamic expression as reflection of the beauty that I see bouncing off my surroundings and again on into and after me. }
...
My inspiration tonight was considering what might thicken this soup well to let it "stick to my bones" by "giving it some body."
...
Grow mushrooms from humanure and organic matter produced by well cultured agroforestry.
...
\section*{ 2020.01.18at23.03.39 }
\subsection*{ Farm mushrooms and make value-added foods which have been acidified via fermentation. }
Farming and fermenting mushrooms is a truly genious idea in the sense it can be done anywhere.
If mushrooms are farmed at a residence then sale of produce can subsidize heat.
If a residence is acquired then the residence can be rented while farming space in the house or yard.
Fungi can be wildly envigorating and stabilizing components of an ecosystem which is studied in exploration of agroforestry.

I intend to explore extending methods of agroforestry by hanging plants from other plants with macrame, fabric, cordage, wattle, wattle and daub, compost, clay, soils of varying composition, branches which could potentially be suspended cuttings, crossed branches attached to the same or neighboring plants, and other products of agroforestry.
Using products of the site allows for a closed loop where closed is often referred to as self-sufficient.
Cordage could be composed of fibers made from plants grown on premises, compost collected from the curb, compost donated by friends, or compost collected from a disposal site for solid waste.

Plants could be grown in soft-bottomed "pots" of macrolichen or decaying foliage.
I intend to research hanging plants growing from bare soil with no container.
Plants could be rooted in a dense network sharing a single rhizosphere which is literally a ball of soil with guilded plants protruding every direction with such density that this rhisphere would not appear to a distant observer to be bare soil.

\section*{ 2020.01.20at07.18.13 }
\subsection*{ Spirit of a Tree of Life: a Human Being a Tree of Life }
A human is a tree of life.
There is one trunk to the standard form of a human.
Fingers, toes, nerves, hair, and appendages protruding from the trunk are dendritic structures.
When a human stands erectly rooted by the feet with bowered arms the head is the apical meristem.

A human being a tree of life.
A human being a node in a tree of lineage.
A tree of lineage is a tree of life.

\section*{ 2020-08-27at18:08:45PDT }

\section*{ 2021.02.23at10.31.58 }
\subsection*{ waking dreams are all I have this morning }
I am resigned to living a waking dream:
I don't remember any dreams from last night's sleep.
Making my waking life my dreamy time seems a fine consolation to me.
I have faith that my well fed and fasted body was fueled to beautifully heal and energize me during my sleep.
I have a plan and the ability to change it as I see fit to make my waking life the best I can dream of it.

\section*{ 2021.07.18at17.42.01 }
\subsection*{ what I learned during my first days on Dean Davis's Promiseland Farm }
Dean demonstrated putting a broadfork in very closely behind the previously forked soil allows a broadfork to move through a compacted bed very quickly.
I had spent a long time doing a much smaller region much less thoroughly prior to Dean's demonstration.
I had been trying to move the fork the full length of the tines.

\section*{ 2021.07.18at17.59.57 }
\subsection*{ My ideas for experimental agriculture }
\begin{itemize}
	\item chop and drop
	\item perennial agriculture of plants including herbs
	\item grow herbs for sale
	\item grow profitable fungi
	\item use urine as solitary fertilization
	\item grow food in a forest
	\item string peas and other climbing plants from trees
	\item harvest many layers of canopy under trees
	\item grow shorter plants nearer the equator and taller plants nearer the nearer of either the North Pole or South Pole
\end{itemize}
