...
I like how the first story of the bible, that everything in the world was fine before some guy didn't follow some rule in someone else's plan for his life and ate the wrong thing, is a fabular}\ref{fabular} warning about disobedience.  \aside{"fabular": t("table") = "tabular" <=> f("fable") = "fabular").

I need to read these journals and run with one of the ideas contained herein to make a million. I master everything I do. I have the tools of science and the pompousity of willingness to go with my first guess at some nondestructive process in whatever way I seek to.

I simply do not want to distract myself from my evolutionary mission, that is the mission of my life's evolution. I just had a compulsion to chew up a big mouthful of raisins and plant the two seeds from a delicious organic orange I just ate whose peel is seen enclosing a well squeeze-packed ball of raisins inside this peel, which was packed atop other orange-peels  into a clear glass container with a compression-lid that uses a metallic lever to  in the pictures I've taken tonight which should be found in accompanying files which has an as-yet-undreamed data-storage-schemum, though I did just buy a portable 1 terrabyte SSD drive to create a cool RAID-array with my years-old 1 terrabyte classically-styled drive with spinning, electromagnetically-encoded disk platters.

I want to give the world journaling and all the things can make out of using a programming-environment as an interface to Computer. I want to deliver the idea of Data being the entiry body of information that is constituted by everything humans know or have recorded. I know I need to get to bed but I am afraid to miss my chance to write these wonderful thoughts. I feel that the things I think are far more complex and beautiful than the surely inadequate breadcrumbs I've left.

My hope with these journal-entries is less to have every entry be meaningful and more to inspire some peice of the energy used to create something beautiful. This journal entry leaves every breadcrumb unfinished, and several more to be started, but I need sleep.
